...
def agent(model, existing_code = None):
  ...
  Use the following plurals:
    ...
    all_instance_code, use_instance_code = parameterAgent(model, SourceConfig, "sources", existing_code, "used_sources", role, tools=[], parameter_rules=parameter_rules, group_validator=checkAll )
    print("USED INSTANCES", use_instance_code)
    return all_instance_code
