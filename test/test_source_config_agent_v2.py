...
from femtomeas.meas_config_agent_v2.source_config import identifySources
...
if __name__ == "__main__":
    ...
    while(1):
        invalidate_later_stages = identifySources(llm, "pion2pt", "", state)
        print("SOURCES", state.sources)
        print("OBS SOURCES", state.observable_sources["pion2pt"])
